                    ...
                    <table id="table-brand-details" class="table">
                        <thead>
                            <tr>
                                ...
                                <th width="25%">Sales last month</th>
                                <th width="25%">Amount last month (VNĐ)</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($products as $product)
                            <tr>
                                ...
                                <td>{{ vnd_format($product->current_price, 1, 1100) ?? 0 }}</td>
                                <td>{{ $product->sales_lm ?? 0 }}</td>
                                <td>{{ vnd_format($product->amount_lm, 1, 1100) ?? 0 }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
